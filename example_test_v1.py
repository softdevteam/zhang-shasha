...
class EmbeddedPython2Suite(EmbeddedPython2Executable):
    ...
    def fromExprModel(exprModel):
        return EmbeddedPython2Suite(
            Schema.PythonSuite(suite=EmbeddedPython2Executable._exprModelAsStmts(deepcopy(exprModel))))
...
class EmbeddedPython2Module(EmbeddedPython2Executable):
    ...
    def fromExprModel(exprModel):
        return EmbeddedPython2Suite(
            Schema.PythonModule(suite=EmbeddedPython2Executable._exprModelAsStmts(deepcopy(exprModel))))
